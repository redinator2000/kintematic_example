...
collides_Minkowski_Set_return collides_Minkowski_Set(i2d, const Minkowski_Set &); // on-way polygons are ignored, unless they have velocity pushing on edge of the point
} // namespace kint
